<template>
  ...
  baseURL: 'https://magento-1150741-4041283.cloudwaysapps.com/rest/V1/',
  headers: {
    'Authorization': 'mjggdbt85kdyf2r1157mob26pyj4ryse',
  },
});
    ...
    try {
      ...
      let apiUrl = `https://magento-1150741-4041283.cloudwaysapps.com/rest/V1/products?searchCriteria[filter_groups][0][filters][0][field]=sku&searchCriteria[filter_groups][0][filters][0][value]=${product_sku}`;
      // if (this.typeFilter) {
